...
* **Core Mechanics**: Implement the main gameplay loop (collecting boba, scoring, etc.).
* **Level Design**: Create playable arenas.
* **UI/UX**: Add main menu, pause menu, and game over screens.
